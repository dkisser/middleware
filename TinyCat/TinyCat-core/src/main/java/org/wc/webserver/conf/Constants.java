...
public class Constants {
    ...
    public static final String DEFAULT_HTTP_SERVER_KEY = "org.wc.tinycat.http.server";

    public static final String DEFAULT_HTTP_SERVER_VALUE = "jetty";

    public static final String DEFAULT_PROPERTIES_KEY = "org.wc.tinycat.file";

    public static final String DEFAULT_PROPERTIES_VALUE = "TinyCat.properties";

    public static final String DEFAULT_IN_SERVER_KEY = "org.wc.tinycat.access.file";
    ...
    public static final String DEFAULT_TCP_SERVER_KEY = "org.wc.tinycat.tcp.server";
    ...
    public static final String TINYCAT_VERSION_KEY = "org.wc.tinycat.version";
